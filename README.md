...
- **Supabase Integration**: Authentication is managed using Supabase.

### Navigation

- **Side Menu**: A side menu for easy navigation between different sections of the app.
- **Routing**: Managed using `go_router` for seamless navigation.
...
- **Settings Page**: Customize app settings.
