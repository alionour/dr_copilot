...
final class HttpApiClient implements ApiClient {
  ...
  Future<Map<String, Object?>> makeRequest(
    ...
    return (_utf8Json.decode(response.bodyBytes)! as Map).cast<String, Object?>();
  }
  ...
  Stream<Map<String, Object?>> streamRequest(
    ...
    if (response.statusCode != 200) {
      ...
      // with `makeRequest`.
      yield (jsonDecode(body) as Map).cast<String, Object?>();
      return;
    }
    final lines =
    ...
    await for (final line in lines) {
      ...
      if (line.startsWith(dataPrefix)) {
        ...
        yield (jsonDecode(jsonText) as Map).cast<String, Object?>();
      }
    }
  }
}
