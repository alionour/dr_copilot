...
LiveServerMessage _parseServerMessage(Object jsonObject) {
  ...
  Map json = jsonObject as Map;

  if (json.containsKey('serverContent')) {
    final serverContentJson = (json['serverContent'] as Map).cast<String, dynamic>();
    Content? modelTurn;
    ...
    Transcription? _parseTranscription(String key) {
      if (serverContentJson.containsKey(key)) {
        final transcriptionJson =
            (serverContentJson[key] as Map).cast<String, dynamic>();
    ...
    final toolContentJson = (json['toolCall'] as Map).cast<String, dynamic>();
