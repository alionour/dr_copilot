...
enum Destination {
  // Core Operations
  copilot(NavItemModel('copilot', Icons.psychology_outlined),
      'Navigate to Copilot'),
  calendar(
      NavItemModel('calendar', Icons.event_outlined), 'View your calendar'),

  // Management
  patients(NavItemModel('patients', Icons.person_search_outlined),
      'Manage your patients'),
  doctors(NavItemModel('doctors', Icons.medical_services_outlined),
      'Manage your doctors'),
  staff(NavItemModel('staff', Icons.badge_outlined), 'Manage your staff'),
  invitations(NavItemModel('invitations', Icons.mail_outline),
      'Manage user invitations'),
  clinicalReports(NavItemModel('clinical_reports', Icons.description_outlined),
      'Manage your clinical reports'),

  // Appointments
  sessions(NavItemModel('sessions', Icons.event_seat_outlined),
      'View your sessions'),
  ...
  liveAssistant(NavItemModel('liveAssistant', Icons.mic_outlined),
