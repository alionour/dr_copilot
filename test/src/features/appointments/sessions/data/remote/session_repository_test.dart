...
void main() {
  group('SessionRepository Tests', () {
    ...
    test('should fetch sessions successfully', () async {
      ...
      when(mockSessionRepository.fetchSessions()).thenAnswer((_) async => sessions);
    ...
    test('should add a session successfully', () async {
      ...
      when(mockSessionRepository.addSession(session)).thenAnswer((_) async => true);
    ...
    test('should delete a session successfully', () async {
      // Arrange
      const sessionId = '1';
      when(mockSessionRepository.deleteSession(sessionId)).thenAnswer((_) async => true);
